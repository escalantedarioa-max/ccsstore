  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "badge-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--color-accent) / 0.35)" },
          "50%": { boxShadow: "0 0 12px 2px hsl(var(--color-accent) / 0.25)" },
        },
      },
      animation: {
